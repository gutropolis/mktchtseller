    ...
    <div class="row">
        <div  class="col-lg-8 col-md-12 col-sm-12 col-xs-12">
               ...
               <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
			    <div style="border:1px solid #fff;text-align:center;padding:10px;background-color:#e8870b;"><h1 style="color:blue;font-size:20px;padding:0px;margin:0px;color:#fff;">A New Product Added By Seller Organisation</h1></div>
				   ...
				   <p style="font-size:13px;">Avilable Units:- {{ $sellerproduct->units }}</p><br /></div>
