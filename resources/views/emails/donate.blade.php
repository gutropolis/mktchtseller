   ...
   <div  class="col-lg-8 col-md-12 col-sm-12 col-xs-12">
      <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
         <div style="border:1px solid #fff;text-align:center;padding:10px;background-color:#e8870b;">
            <h1 style="color:blue;font-size:20px;padding:0px;margin:0px;color:#fff;">Charity Offer For Donation</h1>
         </div>
         <p style="font-size:13px;">Donater Email ID:- {{ $sender_user->email }}</p>
         <p style="font-size:13px;">Donater Name:- {{ $sender_user->full_name }}</p>
         <p style="font-size:13px;">Offer Product:- {{ $product->title }}</p>
         <p style="font-size:13px;">Offer to Donate Units:- {{ $sellerproduct->units }}</p>
