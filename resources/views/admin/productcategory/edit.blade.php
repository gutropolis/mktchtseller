...
<section class="content paddingleft_right15">
    ...
    <div class="row">
        <div class="the-box no-border">
            <!-- errors -->
            {!! Form::model($productcategory, ['url' => URL::to('admin/productcategory/' . $productcategory->id), 'method' => 'put', 'class' => 'bf', 'files'=> true]) !!}
                 ...
                 <div class="row">
                    <div class="col-sm-8">
                        ...
                        <div class="form-group {{ $errors->first('title', 'has-error') }}">
                          <input type="text" name="title" placeholder="Title" class="form-control" value="{!! old('title',$productcategory->title) !!}"/> 
