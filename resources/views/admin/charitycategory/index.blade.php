...
<section class="content paddingleft_right15">
    ...
    <div class="row">
        <div class="the-box no-border">
            <!-- errors -->
            {!! Form::open(array('url' => URL::to('admin/charitycategory'), 'method' => 'post', 'class' => 'bf', 'files'=> true)) !!}
	...
	<td><a href="{{ URL::to('admin/charitycategory/' . $charity->id . '/edit' ) }}"><i class="livicon"
                                    ...
                                    <a href="{{ route('admin.charitycategory.delete', $charity->id) }}"><i class="livicon" data-name="remove-alt"
