...
<section class="content-header">
    <!--section starts-->
    <h1>@lang('Add Charity Category')</h1>
    <ol class="breadcrumb">
        <li>
...
<section class="content paddingleft_right15">
    ...
    <div class="row">
        <div class="the-box no-border">
            <!-- errors -->
            {!! Form::model($charitycategories, ['url' => URL::to('admin/charitycategory/' . $charitycategories->id), 'method' => 'put', 'class' => 'bf', 'files'=> true]) !!}
                 ...
                 <div class="row">
                    <div class="col-sm-8">
						 ...
						 <div class="form-group {{ $errors->first('parent_id', 'has-error') }}">
							...
							<option value="{{$charitycategories->parent_id}}">{{$charitycategories->title}}
                        ...
                        <div class="form-group {{ $errors->first('title', 'has-error') }}">
                          <input type="text" name="title" placeholder="Title" class="form-control" value="{!! old('title',$charitycategories->title) !!}"/> 
						   <span class="help-block">{{ $errors->first('title', ':message') }}</span>
                        </div>
                          <div class="form-group ">
                        <textarea name="description" id="description" class="form-control resize_vertical" placeholder="Description"
                                  rows="4">{!! old('description',$charitycategories->description) !!}</textarea>
