			 ...
			 <div class="panel-body">
                <div class="table-responsive">
					 <div v-if="loaded">
						...
						<td>{{item.location}}</td>
						<td><router-link :to="{name: 'edit_charity', params: { id: item.id }}" class="table-icon" ><svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
