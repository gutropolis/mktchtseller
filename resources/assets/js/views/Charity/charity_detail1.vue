			...
			<div class="col-md-8">
				...
				<div class="col-md-5">
					<div class="charity_inner--content">
						<h4 class="charity_inner--content--heading">Charity Life</h4>
						<p class="charity_inner--content--pera">Contrary to popular belief,Lorem Ipsum.</p>
						<ul class="charity_inner--content--list">
							<li class="charity_inner--content--list--item"><svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
...
<span>Location:</span> Delhi,India </li>
					...
					<div class="charity_profile--detail">
						...
						<b-list-group class="charity__social--list">
							<h4 class="charity__social--list--heading">SHare this post:</h4>
  							<b-list-group-item class="charity__social--list--item" href="#"><svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
...
</svg></b-list-group-item>
  							<b-list-group-item href="#" class="charity__social--list--item"><svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
			 ...
			 M27.865,83.739H41.27V43.409H27.865V83.739z"/>
						...
						<div class="col-12">
							<div class="charity__request">
									...
									<b-link class="charity__request--send btn-bg-orange btn">Send Request</b-link>
							</div>
							</div>
					</div>
				</div>
