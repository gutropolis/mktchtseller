		...
		<div class="row">
			...
			<div class="col-md-9">
				...
				<div class="charity__listing row">
						...
						<div class="col-md-9 charity__listing--content">	
							...
							<div class="charity__listing--content--box">
								...
								<h6 class="charity__listing--content--box--subheading">{{item.year_in_business}}</h6>
								<p class="charity__listing--content--box--pera">{{item.description}}</p>
							</div>
							<div class="charity__listing--content--address row">
								<div class="charity__listing--content--address--location col-md-4 "><p><i class="fa fa-map-marker" aria-hidden="true"></i><span>Location:</span>{{item.business}}</p></div>
				...
				<div class="pagination_element">
					<ul class="pagination">
						<li class="page-item"><a href="#">BACK</a></li>
