 ...
 <section class="page__head">
		<div class="container">
			<div class="page__head--content">
				<h2 class="page__head--content--heading">About us</h2>
				<router-link to="/"><a href="#" class="page__head--content--menu">Home </a></router-link> >
				<a href="#" class="page__head--content--menu">About Us</a>
				
			</div>
		</div>
   </section>
    <section class="equal about_element">
	<div class="container">
		<div class="main_heading">
			<h1 class="main_heading--content">
				<span class="main_heading--content--grey">About</span> Charry<span class="main_heading--content--orange">fab</span>
			</h1>
		</div>
		<div class="row">
			<div class="col-md-6">
				<figure class="about_element--profile"><img src="images/banner-left.jpg"></figure>
			</div>
			<div class="col-md-6">
				<article class="about_element--content">
...
<p>There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don't look even slightly believable. If you are going to use a passage of Lorem Ipsum, you need to be sure there isn't anything embarrassing hidden in the middle of text. All the Lorem Ipsum generators on the Internet tend to repeat predefined chunks as necessary, making this the first true generator on the Internet. It uses a dictionary of over 200 Latin words, combined with a handful of model sentence structures, to generate Lorem Ipsum which looks reasonable. The generated Lorem Ipsum is therefore always free from repetition, injected humour, or non-characteristic words etc.</p>
    ...
    <section class="equal">
		<div class="container">
			<div class="main_heading">
			<h1 class="main_heading--content">
				 FAQ<span class="main_heading--content--orange">'S</span>
			</h1>
		</div>
		<div class="row">	
                        
  <div role="tablist" class="client__accordian">
    <b-card no-body class="mb-1 client__accordian--card">
      <b-card-header header-tag="header" class="p-1 client__accordian--card--header" role="tab">
        <b-link block href="#" v-b-toggle.accordion1 variant="info" class="client__accordian--card--header--link"><span>1.  Sign Up as a School Administrator</span></b-link>
      </b-card-header>
      <b-collapse id="accordion1" class="client__accordian--card--detail" visible accordion="my-accordion" role="tabpanel">
        <b-card-body>
         
          <p class="card-text card-text client__accordian--card--text">
            {{ text }}
          </p>
        </b-card-body>
      </b-collapse>
    ...
    <b-card no-body class="mb-1 client__accordian--card">
      <b-card-header header-tag="header" class="p-1 client__accordian--card--header" role="tab">
        <b-link block href="#" v-b-toggle.accordion2 variant="info" class="client__accordian--card--header--link"><span>3.  Enter your class information</span></b-link>
      </b-card-header>
  ...
  <b-card no-body class="mb-1 client__accordian--card">
      <b-card-header header-tag="header" class="p-1 client__accordian--card--header" role="tab">
        <b-link block href="#" v-b-toggle.accordion3 variant="info" class="client__accordian--card--header--link"><span>4.   Editing Your School Information</span></b-link>
      </b-card-header>
     ...
     <b-card no-body class="mb-1 client__accordian--card">
      <b-card-header header-tag="header" class="p-1 client__accordian--card--header" role="tab">
        <b-link block href="#" v-b-toggle.accordion5 variant="info" class="client__accordian--card--header--link"><span>5. Bringing in New Students</span></b-link>
      </b-card-header>
