			...
			<div class="accordion-wrapper">
							<div class="ac-pane active">
								<a href="#" class="ac-title" data-accordion="true">
									<span>1.  Sign Up as a School Administrator</span>
									<i class="fa"></i>
								</a>
							...
							<div class="ac-pane">
								<a href="#" class="ac-title" data-accordion="true">
									<span>2.  Contrary to popular belief, Lorem?
</span>
									<i class="fa"></i>
								</a>
								<div class="ac-content">
							...
							<div class="ac-pane">
								<a href="#" class="ac-title" data-accordion="true">
									<span>3.  Enter your class information
</span>
									<i class="fa"></i>
								</a>
								<div class="ac-content">
							...
							<div class="ac-pane">
								<a href="#" class="ac-title" data-accordion="true">
									<span>4.   Editing Your School Information</span>
									<i class="fa"></i>
								</a>
								<div class="ac-content">
									Lorem ipsum dolor sit amet, consectetur adipisicing elit. Nihil ullam architecto earum reprehenderit dolore iusto labore sed, sunt, quasi soluta assumenda, a quam aspernatur repudiandae enim. Architecto, assumenda tempore vitae!
							...
							<div class="ac-pane">
								<a href="#" class="ac-title" data-accordion="true">
									<span>5.  Bringing in New Students</span>
									<i class="fa"></i>
								</a>
								<div class="ac-content">
									Lorem ipsum dolor sit amet, consectetur adipisicing elit. Nihil ullam architecto earum reprehenderit dolore iusto labore sed, sunt, quasi soluta assumenda, a quam aspernatur repudiandae enim. Architecto, assumenda tempore vitae!
