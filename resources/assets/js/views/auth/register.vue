...
<div>
  ...
  <li class="nav-item sign_up--item">
    <a class="nav-link sign_up--item--link active" data-toggle="tab" href="#home" role="tab">SELLER </a>
  </li>
  <li class="nav-item sign_up--item">
    <router-link to ="/charityregister" class="nav-link sign_up--item--link" data-toggle="tab"role="tab">CHARITY </router-link>
  </li>  
</ul> 
