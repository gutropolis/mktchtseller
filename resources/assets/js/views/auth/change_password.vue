                    ...
                    <ul class="proflie__element--detail--list">
                        ...
                        <li class="proflie__element--detail--list--item">
                         ...
                         <router-link to="/vender_organisation" class="proflie__element--detail--list--item--link">
                               ...
                               </svg> vender_organisation</router-link>
                        </li>
                        <li class="proflie__element--detail--list--item">
                            <a href="#" class="proflie__element--detail--list--item--link">
                ...
                <div class="dashboard__content clearfix">
                    ...
                    <div class="dashboard__content--outer">
                        ...
                        <div class="dashboard__content--description">
                            <hr>
                            <h3 class="dashboard__content--description--heading">Change Password</h3>
                           
                     <form id="passwordForm" class="form-horizontal form-material" @submit.prevent="changePassword">
					  
					 <div class="form-group">
                            <label class="login__element--box--label">Current Password</label>
                            <input type="password"  placeholder="old password" v-model="passwordForm.current_password"  class="login__element--box--input">
                        </div>
                        
						
                        <div class="form-group">
                            <label class="login__element--box--label">Password</label>
                            <input type="password"  placeholder="new password"  v-model="passwordForm.new_password"  class="login__element--box--input">
                        </div>
						 <div class="form-group">
                            <label class="login__element--box--label">Confirm Password</label>
                            <input type="password_confirm" placeholder="password_confirm" v-model="passwordForm.new_password_confirmation" class="login__element--box--input">
                        </div>
...
export default {
 data() {
	return {
		...
		methods: {
            changePassword() {
                axios.post('/api/user/change-password',this.passwordForm).then(response => {
