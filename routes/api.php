...
Route::get('/subscribed','MembershipController@user_subscription');
...
Route::get('/get_user','UserController@index');
Route::get('/get_inbox','InboxController@recieve_message');
Route::get('/getmessage','InboxController@index');
Route::get('/message_sent','InboxController@sent_message');
